...
const PurchaseOrderForm = () => {
  ...
  const handleVendorChange = async (e) => {
    ...
    if (!e.target.value) {
      ...
      setDeliveryForm({ delivery_name:"", address_line1:"",
    ...
    <div className="pt-0">
      ...
      <StickyHeader>
        <div className="d-flex justify-content-between align-items-center mb-2 pt-0">
          ...
          <div className="d-flex align-items-center gap-2">
            {hasActions && (
              <SplitButton variant="primary" title="Actions" id="actions-dropdown">
                {showAddActions && (
                  <>
                    <Dropdown.Item onClick={() => setShowInvoiceModal(true)}>
                      <FontAwesomeIcon icon={faFileInvoice} className="me-2 text-secondary" />Add Invoice
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => setShowShippingModal(true)}>
                      <FontAwesomeIcon icon={faTruck} className="me-2 text-secondary" />Add Shipping
                    </Dropdown.Item>
                  </>
                )}
